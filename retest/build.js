...
const rawData = fs.readFileSync('./retest/data/articles.json', 'utf8');
...
const indexTemplate = fs.readFileSync('./retest/templates/index.template.html', 'utf8');
const categoryTemplate = fs.readFileSync('./retest/templates/category.template.html', 'utf8');
const articleTemplate = fs.readFileSync('./retest/templates/article.template.html', 'utf8');

// Make sure dist folder exists
if (!fs.existsSync('./retest/dist')) {
  fs.mkdirSync('./retest/dist');
}
